...
class DogSpeciesRecognition(QMainWindow):
    def init_(self):
        ...
        recognitionButton=QPushButton('#6 94',self)
        quitButton=QPushButton('47|7|',self)
        ...
        def recognitionFunction(self):
            ...
            for i in range(5):
                ...
                cv.putText(self.img,prob+name, (10,100+j*30),cv.FONT_HERSHEY_SIMPLEX,0.7, (255,255,255),2) 
            cv.imshow('Dog image',self.img) 
